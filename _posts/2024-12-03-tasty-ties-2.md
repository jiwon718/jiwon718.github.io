...
해당 내용은 첫 번째 내용인 [\[맛잇다\] Spring Boot + WebSocket을 활용한 간단한 채팅 구현](https://spring.io/guides/gs/messaging-stomp-websocket)에서 이어진 것이므로, 이전 글을 읽으시면 해당 글을 이해하시는 데에 많은 도움이 될 것입니다.
