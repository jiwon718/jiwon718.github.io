...
`ChatMessageResponseDto` JSON 직렬화하는 과정에서 오류가 발생한다</mark>는 것을 파악할 수 있었습니다.
...
- <mark style="background-color: "#F0ADC2">`private` 필드나 메소드에 접근할 수 있기 때문에 보안 문제가 발생</mark>할 수 있습니다.
